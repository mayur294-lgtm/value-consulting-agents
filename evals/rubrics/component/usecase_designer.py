...
RUBRIC_ROW = 'usecase-design-rubric'          # the registry key; `--calibration usecase-design-rubric`
COVERS_AGENT = 'usecase-designer'   # INERT DOCUMENTATION — not a verification claim
GOLDEN = 'evals/goldens/usecase_golden.md'

...
- Green border-left (healthy): `border-left: 3px solid #2ECC71`
- Amber border-left (watch): `border-left: 3px solid #D97706`
- Red border-left (critical): `border-left: 3px solid #FF503C`
- Backbase card (target): `background: rgba(51,103,255,0.08); border: 1px solid #3367FF`

### Integration Strip Styling

- **Red strip** (current state — broken): `border: 1px dashed #FF503C; background: rgba(255,114,98,0.04)`
  - Contains: integration pattern name, warning icons, issue description
- **Green strip** (current state — healthy): `border: 1px solid #2ECC71; background: rgba(38,188,113,0.04)`
- **Blue strip** (target state — Backbase): `border: 1px solid #3367FF; background: rgba(51,103,255,0.06)`
  - Contains: "Via Backbase Integration Hub", checkmark icons, benefit description

### Layer Header Styling

- Background: `#F3F6F9`
- Left border: `3px solid #3367FF`
...
|- Blue (#3367FF) section divider: "IT Architecture & Operations  01"
...
|- Blue (#3367FF) section divider: "IT Goals & Challenges  02"
...
|- Blue (#3367FF) section divider: "Current State Architecture  03"
...
|- Blue (#3367FF) section divider: "Target State with Backbase  04"
...
|- Blue (#3367FF) section divider: "Getting There  05"
...
|- CLOSING: Dark (#041326) background, "THANK YOU", "Backbase"
```
...
- [ ] Section dividers use BLUE (`#3367FF`) background with "Backbase" wordmark
- [ ] Cover and closing use DARK (`#041326`) background
...
- [ ] No old/wrong colors: `#0052CC`, `#172B4D`, `#F4F5F7`, `#00C7E6`, `#041326`, `#3367FF`, `#041326`
- [ ] Cards use `#F3F6F9` bg, `#EBF0FF` border

...
1. **Technology Landscape Hypothesis** — Systems identified and their classification (core banking, channels, integration, etc.)
2. **Application Disposition Recommendations** — Which apps to RETAIN/REPLACE/RETIRE with supporting rationale
3. **Integration Pattern Recommendations** — Proposed approach for core banking and key systems
4. **Questions & Flags** — Any gaps about the client's actual tech stack, vendor contracts, or integration constraints

Say: "Please review my analysis before I generate the workshop deck. Are there any corrections, additions, or changes?"

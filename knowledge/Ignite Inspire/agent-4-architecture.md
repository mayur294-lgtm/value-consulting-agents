...
- Red border-left (critical): `border-left: 3px solid #E02020`
- Backbase card (target): `background: rgba(26,90,255,0.08); border: 1px solid #1A5AFF`

### Integration Strip Styling

- **Red strip** (current state — broken): `border: 1px dashed #E02020; background: rgba(255,114,98,0.04)`
...
- **Blue strip** (target state — Backbase): `border: 1px solid #1A5AFF; background: rgba(26,90,255,0.06)`
  - Contains: "Via Backbase Integration Hub", checkmark icons, benefit description

### Layer Header Styling

- Background: `#F5F7F9`
- Left border: `3px solid #1A5AFF`
...
**Key rules:**
- Colors: Use official Backbase brand colors (`#1A5AFF` primary blue, `#001C3D` primary dark, `#93B5FF` cyan accent). See `knowledge/design-system.md` Section 1 for full palette.
...
|- Blue (#1A5AFF) section divider: "IT Architecture & Operations  01"
...
|- Blue (#1A5AFF) section divider: "IT Goals & Challenges  02"
...
|- Blue (#1A5AFF) section divider: "Current State Architecture  03"
...
|- Blue (#1A5AFF) section divider: "Target State with Backbase  04"
...
|- Blue (#1A5AFF) section divider: "Getting There  05"
...
|- CLOSING: Dark (#001C3D) background, "THANK YOU", "Backbase"
```

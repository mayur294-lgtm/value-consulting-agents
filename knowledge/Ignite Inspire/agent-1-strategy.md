...
|- Blue (#1A5AFF) section divider: "Strategy Alignment  02"
...
|- Blue (#1A5AFF) section divider before first canvas:
|  "Vision to Value  03"
...
- [ ] Tables use `#1A5AFF` header, alternating white/`#F5F7F9` rows

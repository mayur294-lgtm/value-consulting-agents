...
|- Blue (#3367FF) section divider: "Strategy Alignment  02"
...
|- Blue (#3367FF) section divider before first canvas:
|  "Vision to Value  03"
...
- [ ] Tables use `#3367FF` header, alternating white/`#F3F6F9` rows

...
6. Use Agent 7 (Phase A) → Upload context → Get customized questionnaire
   
   [CLIENT FILLS QUESTIONNAIRE]
   
7. Use Agent 7 (Phase B) → Upload filled questionnaire → Get business case + ROI

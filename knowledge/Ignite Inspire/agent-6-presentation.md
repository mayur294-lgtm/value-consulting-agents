...
- **Section dividers**: BLUE (`#3367FF`) background, white text, "Backbase" wordmark top-left, ghost number
...
- **Phone frame** (375x812px, `#041326` border) for member/customer use cases — mobile-first
...
- **Prototype buttons**: `#3367FF` background, white text, 12px border-radius
...
# Use as: <img src="data:image/jpeg;base64,{b64}" alt="..." style="width:100%; border-radius:12px; box-shadow: 0 4px 24px rgba(4,19,38,0.1);">
```

**Standard image styling:**
```html
<img src="data:image/jpeg;base64,..." alt="Backbase Platform Overview"
     style="width:100%; border-radius:12px; box-shadow: 0 4px 24px rgba(4,19,38,0.1);">
```
...
- Dot color follows priority: P1 = `#3367FF`, P2 = `#6B7786`, P3 = `#5A6A7E`
...
|----------|-------|-------|--------|
| High Value / Low Complexity | Quick Wins | `#2ECC71` (green) | Implement first, immediate value |
| High Value / High Complexity | Strategic | `#3367FF` (blue) | Plan carefully, high payoff |
| Low Value / Low Complexity | Fill | `#6B7786` (grey) | Include if capacity allows |
| Low Value / High Complexity | Deprioritize | `#FF503C` (red) | Not now, revisit later |
...
- [ ] NO wrong colors: `#0052CC`, `#172B4D`, `#041326`, `#3367FF`, `#041326`, `#F4F5F7`, `#00C7E6`
- [ ] Content sections: WHITE (`#FFFFFF`) background
- [ ] Section dividers: BLUE (`#3367FF`) background with ghost numbers
- [ ] Cover & closing: DARK (`#041326`) background
...
- [ ] Cards: `#F3F6F9` background, `#EBF0FF` border
- [ ] Tables: `#3367FF` header, alternating white/`#F3F6F9` rows

...
- **Section dividers**: BLUE (`#1A5AFF`) background, white text, "Backbase" wordmark top-left, ghost number
...
- **Phone frame** (375x812px, `#001C3D` border) for member/customer use cases — mobile-first
...
- **Prototype buttons**: `#1A5AFF` background, white text, 12px border-radius
...
# Use as: <img src="data:image/jpeg;base64,{b64}" alt="..." style="width:100%; border-radius:12px; box-shadow: 0 4px 24px rgba(0,28,61,0.1);">
```

**Standard image styling:**
```html
<img src="data:image/jpeg;base64,..." alt="Backbase Platform Overview"
     style="width:100%; border-radius:12px; box-shadow: 0 4px 24px rgba(0,28,61,0.1);">
```
...
- Dot color follows priority: P1 = `#1A5AFF`, P2 = `#5C6E84`, P3 = `#5A6A7E`
...
| High Value / High Complexity | Strategic | `#1A5AFF` (blue) | Plan carefully, high payoff |
| Low Value / Low Complexity | Fill | `#5C6E84` (grey) | Include if capacity allows |
| Low Value / High Complexity | Deprioritize | `#E02020` (red) | Not now, revisit later |
...
- [ ] NO wrong colors: `#0052CC`, `#172B4D`, `#001C3D`, `#1A5AFF`, `#001C3D`, `#F4F5F7`, `#00C7E6`
- [ ] Content sections: WHITE (`#FFFFFF`) background
- [ ] Section dividers: BLUE (`#1A5AFF`) background with ghost numbers
- [ ] Cover & closing: DARK (`#001C3D`) background
...
- [ ] Cards: `#F5F7F9` background, `#EBF0FF` border
- [ ] Tables: `#1A5AFF` header, alternating white/`#F5F7F9` rows

...
├── Blue (#3367FF) section divider: "Ignite Day Objectives  01"
...
├── Use numbered circles (#3367FF bg, white text) for 01, 02, 03
...
├── Blue (#3367FF) section divider: "Ignite Day Agenda  02"
...
├── Blue (#3367FF) section divider: "Preparation Workshops  03"
...
│   └── Proposed Dates
├── Table styling: #3367FF header, alternating white/#F3F6F9 rows
...
├── Card styling: #F3F6F9 bg, #EBF0FF border, 12px radius
...
├── Blue (#3367FF) section divider: "Final Deliverables  04"
├── Content section (WHITE background)
...
───────────────────────────────
Content sections:    WHITE (#FFFFFF) background, dark text (#041326)
Section dividers:    BLUE (#3367FF) background, white text, "Backbase" wordmark top-left
Cover & closing:     DARK (#041326) background, white text

COLORS (Official Backbase Palette)
──────
Primary Dark:        #041326  (text on white, cover/closing bg)
Primary Blue:        #3367FF  (accent, CTAs, section divider bg, headers)
...
Muted Blue-Grey:     #6B7786  (secondary text on white slides)
Green/Amber/Red:     #2ECC71 / #D97706 / #FF503C  (status indicators)
...
- Small blue accent square (#3367FF, ~16px) left of every title
- "Backbase" wordmark top-left on section dividers

COMPONENTS (White/Light Theme)
──────────
Cards:               #F3F6F9 bg, #EBF0FF border, 12-16px radius
Tables:              #3367FF header with white text, alternating white/#F3F6F9 rows
Numbered circles:    #3367FF bg, white text (for objectives 01, 02, 03)
Status badges:       Green=scheduled, Amber=pending, Red=blocked
```

**DO NOT** use these old/wrong colors: `#041326`, `#3367FF`, `#041326`, `#3367FF`
...
(#3367FF bg, white text) for each step number.
...
- [ ] Section dividers use BLUE (#3367FF) background, not dark

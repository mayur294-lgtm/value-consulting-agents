...
- **Primary blue**: `#3367FF` (buttons, headers, links, progress indicators)
- **Text**: `#041326` (headings), `#6B7786` (body), `#5A6A7E` (secondary)
- **Backgrounds**: `#FFFFFF` (screen), `#F3F6F9` (input fields, cards)
- **Success**: `#2ECC71` | **Warning**: `#D97706` | **Error**: `#FF503C`
- **Font**: System font stack (`-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif`)
- **Phone frame border**: `#041326` (dark shell)
- **Browser frame chrome**: `#F3F6F9` (light grey toolbar)
- **Buttons**: `#3367FF` background, white text, 12px border-radius
- **Input fields**: `#F3F6F9` background, 1px `#EBF0FF` border, 10px border-radius
...
- [ ] NO wrong colors: `#0052CC`, `#172B4D`, `#041326`, `#3367FF`, `#041326`

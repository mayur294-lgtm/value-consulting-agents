...
- **Primary blue**: `#1A5AFF` (buttons, headers, links, progress indicators)
- **Text**: `#001C3D` (headings), `#5C6E84` (body), `#5A6A7E` (secondary)
- **Backgrounds**: `#FFFFFF` (screen), `#F5F7F9` (input fields, cards)
- **Success**: `#2ECC71` | **Warning**: `#D97706` | **Error**: `#E02020`
- **Font**: System font stack (`-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif`)
- **Phone frame border**: `#001C3D` (dark shell)
- **Browser frame chrome**: `#F5F7F9` (light grey toolbar)
- **Buttons**: `#1A5AFF` background, white text, 12px border-radius
- **Input fields**: `#F5F7F9` background, 1px `#EBF0FF` border, 10px border-radius
- **Cards inside prototype**: `#F5F7F9` background, 12px border-radius
...
- Frame height: 720px
- Chrome bar: 40px height, `#F5F7F9` background
...
- [ ] NO wrong colors: `#0052CC`, `#172B4D`, `#001C3D`, `#1A5AFF`, `#001C3D`

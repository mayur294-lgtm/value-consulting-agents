# Capability Taxonomy — Investing / Digital Wealth
...
> This slice: ~Investing / Digital Wealth capabilities only
> Note: For pure investing engagements (e.g., self-directed trading), use this slice. For full wealth management (advisor-led), use the wealth slice.

...
**Key rules:**
- Colors: Use Backbase Unified Frontline 2026 brand colors ONLY (`#1A5AFF` action blue, `#001C3D` navy, `#E02020` red, `#2ECC71` green, `#D97706` amber, `#5C6E84` muted, `#F5F7F9` bg gray). See `knowledge/design-system.md` Section 1 for full palette. NO cyan headlines, NO purple headlines, NO ENGAGE 2026 hexes (`#3366FF`, `#0F172A`, `#FF6B5E`, `#93C47D`, `#E8B931` are deprecated).

...
> Map the architecture of the project: module structure, activation flow, key abstractions, how components communicate. Report file paths for everything you read.

## Mode 2: Pattern Matching

> Find features similar to [FEATURE] in the project. Document coding conventions, file organization patterns, testing patterns, and UI patterns. Report file paths.

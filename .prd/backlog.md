...
- [done v9] .prd/prd-v5.md:83 — the fixtures row paired a real client name with a real deal ID; genericize the ID (client names in planning docs are repo norm; the NAME-PLUS-DEAL-ID pairing is the elevated-sensitivity element, so this line deliberately does not reproduce it). Closed by the 2026-08-30 repo scrub — the row now names only the synthetic Meridian Bank fixtures (from PR #153 review)

...
This sharpens the consultant's thinking and pressure-tests the output before a client ever sees it. Full triggers, suppression rules, and examples: `knowledge/standards/critical_thought_partner_protocol.md`.
